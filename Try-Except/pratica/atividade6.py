# Enunciado: Crie um programa que possa gerar diferentes erros: divisão por zero, erro de tipo e índice fora da lista. Use diferentes blocos except para cada tipo de erro.
