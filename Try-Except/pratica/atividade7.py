# Enunciado: Implemente um programa que utilize o else junto com try e except. O bloco else deve ser executado quando nenhum erro ocorrer.
...
for valor in valores:
    try:
        ...
        print("Nenhum erro ocorreu, todas as operações foram bem-sucedidas.")